...
run_path = '../test_data/comp/comp_seq1/'
N_T_TASK = 15
N_G_TASK = 10
...
# Training
pl = Gibbs_sampler(Program_lib(pm_init), training_data_1, iteration=100)
pl.run(save_prefix=f'{run_path}training_1/pm')

pl = Gibbs_sampler(Program_lib(pl.cur_programs), training_data_2, iteration=10)
