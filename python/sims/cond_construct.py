...
g1.run(all_frames, top_n=3, exceptions_allowed=1, save_prefix='samples/construct_a')
...
g2.run(all_frames, top_n=3, exceptions_allowed=1, save_prefix='samples/construct_b')
