...
data = data.query('condition==2&component==2')
task_data = []
...
pt = Gibbs_sampler(Program_lib(pm_init, 0.1), task_data, inc=False, iteration=100)
pt.run(save_prefix='r2_c2_bat_sam1/pm', sample=True, top_n=1)