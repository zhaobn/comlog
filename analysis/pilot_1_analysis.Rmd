...
t7 = df.tw %>% 
  ...
  geom_line(aes(color=condition),linetype="dashed", size=1.2) +
  geom_point(aes(color=condition, shape=condition), size=3.5) +
  labs(x='', y='Percent correct', title='Trial 7 (4 stripes, 0 dots)') +
  ylim(0,100) +
  theme_bw()
...
t3 = df.tw %>% 
  ...
  geom_line(aes(color=condition),linetype="dashed", size=1.2) +
  geom_point(aes(color=condition, shape=condition), size=3.5) +
  labs(x='', y='Percent correct', title='Trial 1,2,3 (0 stripes)') +
  ylim(0,100) +
  theme_bw()
...
t4 = df.tw %>%
  ...
  geom_line(aes(color=condition),linetype="dashed", size=1.2) +
  geom_point(aes(color=condition, shape=condition), size=3.5) +
  labs(x='', y='Percent correct', title='Trial 4,5,6,8 (stripes > 0, dots > 0)') +
  ylim(0,100) +
  theme_bw()
...
df.tw %>%
  ...
  ylim(0, 100) +
  labs(x='', y='percent explained', title='Trial 4,5,6,8, phase A mis-predictions') +
  theme_bw()
